...
const data01 = [{
  id: 0, name: 'Bicicleta', value: 10, fill: '#4ce1b6',
}, {
  id: 1, name: 'Hit', value: 37, fill: '#70bbfd',
}, {
  id: 2, name: 'Correr', value: 21, fill: '#f6da6e',
}, {
  id: 3, name: 'Gym', value: 32, fill: '#ff4861',
}];
...
const ActivityRating = ({ dir, themeName }) => {
  ...
  return (
    <Panel lg={12} xl={6} md={12} title={'Ejercicios más concurridos'}>
    {/* title={t('fitness_dashboard.activity_rating')}> */}
      <div dir="ltr">
