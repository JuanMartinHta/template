...
const data = [
  {
    id: 0, name: 'Juan Pérez', result: '12,254 km', ava: Ava1,
  }, {
    id: 1, name: 'Juan Pérez', result: '11,224 km', ava: Ava2,
  }, {
    id: 2, name: 'Juan Pérez', result: '9,921 km', ava: Ava3,
  }, {
    id: 3, name: 'Juan Pérez', result: '7,875 km', ava: Ava4,
  }, {
    id: 4, name: 'Juan Pérez', result: '6,154 km', ava: Ava5,
  }, {
    id: 5, name: 'Juan Pérez', result: '6,154 km', ava: Ava6,
  },
];
...
const MyCompetitors = () => {
  ...
  return (
    ...
    <Panel lg={5} xl={3} md={12} xs={12} title={'Ranking'}>
      {data.map(item => (
