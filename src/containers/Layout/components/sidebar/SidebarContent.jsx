...
const SidebarContent = ({
  ...
  <div className="sidebar__content">
    ...
    <ul className="sidebar__block">
      <SidebarCategory title="UI" icon="diamond" sidebarCollapse={sidebarCollapse}>
        <SidebarLink title="Alertas" route="/ui/alerts" onClick={onClick} />
        <SidebarLink title="Botones" route="/ui/buttons" onClick={onClick} />
        <SidebarLink title="Carusel" route="/ui/carousel" onClick={onClick} />
        ...
        <SidebarLink title="Notificaciones" route="/ui/notifications" onClick={onClick} />
      ...
      <SidebarCategory title="Tables" icon="list" sidebarCollapse={sidebarCollapse}>
        ...
        <SidebarLink title="Data table" route="/tables/data_table" onClick={onClick} />
        <SidebarLink title="Drag & Drop table" route="/tables/dnd_table" onClick={onClick} />
